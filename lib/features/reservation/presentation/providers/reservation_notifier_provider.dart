...
import 'package:levy/features/reservation/presentation/providers/reservation_usecase_provider.dart';
...
final reservationNotifierProvider = StateNotifierProvider<ReservationNotifier, ReservationState>((ref) {
  return ReservationNotifier(ref.read(createReservationUseCaseProvider));
});